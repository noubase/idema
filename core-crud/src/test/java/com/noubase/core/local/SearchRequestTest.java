package com.noubase.core.local;
...
import static com.noubase.core.crud.model.search.SearchRequest.ALL_FIELDS;
...
public class SearchRequestTest {
    ...
    public void testInit() {
        ...
        assertThat(r.getType(), CoreMatchers.is(SearchType.EXACT));
